---
title: 'Introducing Tailwind Nextjs Starter Blogs'
date: '2021-01-12'
lastmod: '2021-12-15'
tags: ['next-js', 'tailwind', 'guide']
draft: false
summary: 'Looking for a performant, out of the box template, with all the best in web technology to support your blogging needs? Checkout the Tailwind Nextjs Starter Blogs template.'
...
- [Demo Blogs](https://tailwind-nextjs-starter-blog.vercel.app/) - this repo
...
5. Modify `headerNavLinks.tsx` to customize navigation links
6. Add blog posts
7. Deploy on Vercel
...
`data/headerNavLinks.tsx` - navigation links.
...
```
---
title: 'Introducing Tailwind Nexjs Starter Blogs'
date: '2021-01-12'
lastmod: '2021-01-18'
tags: ['next-js', 'tailwind', 'guide']
draft: false
